...
//
//public class ReadSignUpData  extends AppCompatActivity {
//
...
//
//                        Intent intent1 = new Intent(ReadSignUpData.this, accountSettings.class);
//                        intent1.putExtra("firstnameKey", first);
//                        startActivity(intent1);
//
//                        Intent intent2 = new Intent(ReadSignUpData.this, accountSettings.class);
//                        intent2.putExtra("lastnameKey", last);
//                        startActivity(intent2);
//
//                        Intent intent3= new Intent(ReadSignUpData.this, accountSettings.class);
